...
class StandoneCode:
    ...
    def load_model_epoch(self, model, epoch, d12, d3, d4,d5, r):
        assert os.path.exists("{}models/{}/pysparams:d12={}_d3={}_d4={}_d5={}_r={}_epo={:d}_class.h5".format(self.path, self.model_params['model_name'], d12, d3, d4,d5, r, epoch))\
...
def parse_args():
    ...
    parser.add_argument("--train", choices=["python", "sql"], default="python",
